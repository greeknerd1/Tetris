...
public class LShape extends Shape {
	...
	void setUpBlockArray() {
		...
		blocks.add(new Block(Color.ORANGE, 2, 1, width, height));
		blocks.add(new Block(Color.ORANGE, 1, 1, width, height));
		blocks.add(new Block(Color.ORANGE, 0, 1, width, height));
		blocks.add(new Block(Color.ORANGE, 0, 0, width, height));
		isSetup = true;
	}
